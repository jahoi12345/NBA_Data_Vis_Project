import{z as de,Y as u,H as L,G as pe}from"./jsonMap-Bs3hmeCU-Cusd0Fmz.js";import{I as m,O as k,L as T,$ as K,V as _,l as A,x as j,v as Z,F as ue}from"./vec32-CewSdTn3-VRto2OOh.js";import{t as o,X as N,M as $}from"./collectionUtils-jDyktm0P-BDP2Oq99.js";import{P as I,c as fe,w as R,s as ge,b as me,C as _e,q as be,L as Pe,E as ve}from"./frustum-CMzahy3--B-DC1Co-.js";import{o as we}from"./VisualElement-By4iq8p4-ZBataKFH.js";import{b as Ve,o as xe,Q as De,y as Ee}from"./sphere-DLQ6p7mp-DyEe1Vll.js";import{aW as ye,aY as W,cL as Le,y as Se,N as Q,B as J,O as Ce,E as Me,V as Ae,ay as ee,bN as Re,n as Te,W as Oe,j as te,az as Ie,aT as S,R as Ue,bl as C,S as qe,bY as ze,U as je,ca as V}from"./Texture-CFNZjV2R-CxGjQ8pI.js";import{bG as Ne,ar as $e,bF as We}from"./ShadowCastClear.glsl-CeOT_rAo-BEYyVrmo.js";import{i as He}from"./DoubleArray-DExKNiTh-CvVpHySW.js";import{p as ie,n as Fe}from"./InterleavedLayout-B7roQAzV-CdGz7mlm.js";import{E as Be}from"./enums-B4pqBiXb-BO-3hS_8.js";import{H as ne}from"./index-B0z_nLWi.js";import{y as U}from"./mathUtils-PIGhLnI9-B1tKUlUb.js";import{F as se}from"./Polygon-D6wEPb3W-D2MPjRU4.js";import{o as re}from"./vec2f64-rIxtbMRN-Kai9mK1i.js";import{P as ae}from"./vec42-B8VM4vXb-B6OGOEI9.js";import{o as Ge}from"./vec4f64-DPb6J-GU-C7c2DqbZ.js";import"./vector-B8ZDYGQ6-DRILJdcx.js";import{y as f,m as H,n as l,A as v,C as F}from"./Emissions.glsl-B8XKMjLy-DXfiRNVX.js";import{X as Xe,K as Ye}from"./plane-BNdSPG2o-DTV5z6SO.js";import{L as ke}from"./mat4-C96X-Nn0-BrMLOLCb.js";import{n as Ke}from"./mat4f64-q_b6UJoq-Dh6sWB_w.js";let B=class{constructor(t){this._renderCoordsHelper=t,this._origin=o(),this._dirty=!1,this._count=0}set vertices(t){const e=He(3*t.length);let i=0;for(const n of t)e[i++]=n[0],e[i++]=n[1],e[i++]=n[2];this.buffers=[e]}set buffers(t){if(this._buffers=t,this._buffers.length>0){const e=this._buffers[0],i=3*Math.floor(e.length/3/2);T(this._origin,e[i],e[i+1],e[i+2])}else T(this._origin,0,0,0);this._dirty=!0}get origin(){return this._origin}draw(t){const e=this._ensureVAO(t);e!=null&&(t.bindVAO(e),t.drawArrays(Be.TRIANGLES,0,this._count))}dispose(){this._vao!=null&&this._vao.dispose()}get _layout(){return this._renderCoordsHelper.viewingMode===1?Qe:Je}_ensureVAO(t){return this._buffers==null?null:(this._vao??=this._createVAO(t,this._buffers),this._ensureVertexData(this._vao,this._buffers),this._vao)}_createVAO(t,e){const i=this._createDataBuffer(e);return this._dirty=!1,new $e(t,new Ce(t,Fe(this._layout),i))}_ensureVertexData(t,e){if(!this._dirty)return;const i=this._createDataBuffer(e);t.buffer()?.setData(i),this._dirty=!1}_createDataBuffer(t){const e=t.reduce((d,c)=>d+G(c),0);this._count=e;const i=this._layout.createBuffer(e),n=this._origin;let s=0,r=0;const a="startUp"in i?this._setUpVectors.bind(this,i):void 0;for(const d of t){for(let c=0;c<d.length;c+=3){const y=T(X,d[c],d[c+1],d[c+2]);c===0?r=this._renderCoordsHelper.getAltitude(y):this._renderCoordsHelper.setAltitude(y,r);const g=s+2*c;a?.(c,g,d,y);const z=K(X,y,n);if(c<d.length-3){for(let b=0;b<6;b++)i.start.setVec(g+b,z);i.extrude.setValues(g,0,-1),i.extrude.setValues(g+1,1,-1),i.extrude.setValues(g+2,1,1),i.extrude.setValues(g+3,0,-1),i.extrude.setValues(g+4,1,1),i.extrude.setValues(g+5,0,1)}if(c>0)for(let b=-6;b<0;b++)i.end.setVec(g+b,z)}s+=G(d)}return i.buffer}_setUpVectors(t,e,i,n,s){const r=this._renderCoordsHelper.worldUpAtPosition(s,Ze);if(e<n.length-3)for(let a=0;a<6;a++)t.startUp.setVec(i+a,r);if(e>0)for(let a=-6;a<0;a++)t.endUp.setVec(i+a,r)}};function G(t){return 3*(2*(t.length/3-1))}const Ze=o(),X=o(),Qe=ie().vec3f("start").vec3f("end").vec2f("extrude").vec3f("startUp").vec3f("endUp"),Je=ie().vec3f("start").vec3f("end").vec2f("extrude");function le(t,e){const i=t.fragment;i.include(qe),t.include(ze),i.include(We),i.uniforms.add(new f("globalAlpha",n=>n.globalAlpha),new v("glowColor",n=>n.glowColor),new f("glowWidth",(n,s)=>n.glowWidth*s.camera.pixelRatio),new f("glowFalloff",n=>n.glowFalloff),new v("innerColor",n=>n.innerColor),new f("innerWidth",(n,s)=>n.innerWidth*s.camera.pixelRatio),new je("depthMap",n=>n.depth?.attachment),new F("normalMap",n=>n.normals)),i.code.add(l`vec4 premultipliedColor(vec3 rgb, float alpha) {
